...
-- Tabela de Alunos (com campos opcionais para nome da mãe e pai)
CREATE TABLE Alunos (
    id INT PRIMARY KEY AUTO_INCREMENT,
    nome VARCHAR(100) NOT NULL,
    ...
    codigo_carteirinha VARCHAR(10) NOT NULL UNIQUE,
    data_cadastro DATETIME DEFAULT CURRENT_TIMESTAMP,
    ativo BOOLEAN DEFAULT TRUE,
...
-- View para relatório de alunos por gênero e idade (com campos opcionais de mãe e pai)
